          ...
          <div class="col-sm-6 col-lg-4 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                <?php endif; ?>
                <?php
                $podcastsContent = get_field('short_description', $post->ID);
                if ($podcastsContent) : ?>
                  <p class="card-text"><?php echo wp_trim_words($podcastsContent, 30, '...'); ?></p>
                <?php endif; ?>
              </div>
              <div class="card-footer bg-transparent border-top-0 text-end">
                <a href="<?php the_permalink(); ?>" class="read-more-link" title="Know More">Know More<img src="<?php echo THEME_PATH; ?>assets/images/Iconfeather-arrow-right.svg" alt="navigation right" /></a>
...
function get_search_result_listing()
{
  ...
  if ($flag == 'search_result') {
    $post_type = array('post', 'page', 'case_studies', 'ebooks', 'podcasts', 'whitepapers', 'webinars', 'press-release');
    $items_per_page = 10;
    $content_priority = 'content_priority';
  }
