										...
										<aside class="sidebar">
											<?php if (get_field('sidebar_title') != '') { ?>
												<div class="sidebar-content">
													<h3><a href="<?php echo the_field('sidebar_button_url');?>"><?php echo the_field('sidebar_title'); ?></a></h3>
													<?php if (get_field('sidebar_image') != '') { ?>
														<a href="<?php echo the_field('sidebar_button_url');?>"><img src="<?php echo the_field('sidebar_image');?>" alt="<?php echo the_field('sidebar_title'); ?>"></a>
													<?php } ?>
													<?php if (get_field('sidebar_button_url') != '') { ?>
														<a href="<?php echo the_field('sidebar_button_url');?>" class="btn"><span class="text"><?php echo the_field('sidebar_button_label');?></span><span class="effect"></span></a>
													<?php } ?>
												</div>
											<?php } ?>										
											<?php
											...
											<div class="subscribers-form">
												 ...
												 <?php echo do_shortcode('[contact-form-7 id="35871" title="Blog Subscribers Form"]'); ?>
											</div>	
											</div>										
											<?php  $relatedPost = get_posts(
													array(
